...
import com.ndn.spark.util.collection.SortDataFormat1;
 ...
 * This generalization comes with minimal overhead -- see SortDataFormat1 for more information.
 *
 * We allow key reuse to prevent creating many key objects -- see SortDataFormat1.
 *
 * @see com.ndn.spark.util.collection.SortDataFormat1
...
public class TimSort<K, Buffer> {
    ...
    private final SortDataFormat1<K, Buffer> s;

    public TimSort(SortDataFormat1<K, Buffer> sortDataFormat) {
