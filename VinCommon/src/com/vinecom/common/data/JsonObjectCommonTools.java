...
class JsonObjectCommonTools {
    ...
    static CommonData fromJson(String json) {
        ...
        if (o instanceof JSONObject) {
            ...
            throw new IllegalArgumentException("The only JSONObject and JSONArray is accepted");
        }
    }
    ...
    private static CommonObject fromJSONObject(JSONObject obj) {
        ...
        for (Map.Entry<String, Object> e : obj.entrySet()) {
            if (e.getValue() instanceof JSONObject) {
                commonObject.setCommonData(e.getKey(), fromJSONObject((JSONObject) e.getValue()));
            } else if (e.getValue() instanceof JSONArray) {
                commonObject.setCommonData(e.getKey(), fromJSONArray((JSONArray) e.getValue()));
            } else {
                commonObject.set(e.getKey(), e.getValue());
            }
        }
        return commonObject;
    }
